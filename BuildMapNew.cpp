...
void MostrarCascata() {
    ...
    cout << "Desvantagens:\n" << endl;
    cout << "- Rigidez e dificuldade de mudanças.\n";
    cout << "- Feedback tardio e risco alto.\n";
    cout << "- Processo demorado.\n";
    string confirmar;
...
void MostrarEspiral() {
    ...
    cout << "Vantagens:\n" << endl;
    cout << "- Melhora a gestão de riscos.\n";
    cout << "- Flexibilidade para mudancas durante o desenvolvimento.\n";
    cout << "- Adequado para projetos grandes e complexos.\n" << endl;
    cout << "Devantagens:\n" << endl;
    cout << "- Complexidade e custo elevados.\n";
    cout << "- Análise de risco difícil.\n";
    cout << "- Pouco adequado para pequenos projetos.\n";
    string confirmar;
    cout << "\nDigite algo e enter para voltar ao menu anterior: ";
    cin >> confirmar;
    VantagensEDesvantagens();
...
void MostrarPrototipagem() {
    ...
    cout << "Devantagens:\n" << endl;
    cout << "- Ambiguidade nos requisitos.\n";
    cout << "- Gestão difícil e expectativas irreais.\n";
    cout << "- Comprometimento da qualidade.\n";
    string confirmar;
    cout << "\nDigite algo e enter para voltar ao menu anterior: ";
    cin >> confirmar;
    VantagensEDesvantagens();
...
void MostrarIncremental() {
    ...
    cout << "Desvantagens:\n" << endl;
    cout << "- Integração complexa.\n";
    cout << "- Planejamento complicado.\n";
    cout << "- Risco de retrabalho e sensação de incompletude.\n";
    string confirmar;
    cout << "\nDigite algo e enter para voltar ao menu anterior: ";
    cin >> confirmar;
    VantagensEDesvantagens();
